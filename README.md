...
**(2)** Advised: run with the below VBScript Wrapper. This avoids possible execution policy hiccups.

VBScript Wrapper:

"Set WshShell = CreateObject("WScript.Shell")
WshShell.Run "powershell.exe -ExecutionPolicy Bypass -File ""C:\LOCATION OF SCRIPT\MonitorBlackout.PS1""", 0, False"

-> save as LaunchBlackout.vbs file and launch this file.

**(3)** Run the script from Task scheduler (with (via) or without the VBScript Wrapper).

# Current issues and potential updates (v1.0.0, 09/01/2026)
...
- The "How to" section of the ReadMe should be updated and/or the launch options should be redone and better integrated into the software and repository.
