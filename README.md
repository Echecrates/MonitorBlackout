# MonitorBlackout
This is a Powershell script that dims a (second) monitor. Users can disable/re-enable the script with a hotkey (Ctrl + Alt + B) and a system tray icon shows whether it is enabled or disabled.
